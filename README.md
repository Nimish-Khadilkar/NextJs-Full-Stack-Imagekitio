...
# Next.js Imagekit – Full Stack App (Next.js + MongoDB)
...
```bash
git clone https://github.com/Nimish-Khadilkar/NextJs-Full-Stack-Imagekitio.git
```

### 2\. Install Dependencies

```bash
cd NextJs-Full-Stack-Imagekitio
npm install
```
